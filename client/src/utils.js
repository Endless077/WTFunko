...
export const config = {
    ...
    endpoints: {
        ...
        getProductsFromPage: { url: "/getProductsFromPage/{pageIndex}", method: "GET" },
        getUniqueProductsCount: { url: "/getUniqueProductsCount", method: "GET" },
...
export const getApiUrl = (endpoint) => `http://${config.api_url}:${config.api_port}${endpoint}`;
